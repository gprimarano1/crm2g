...
import { getClientesParaRelatorio, getSemanas } from "@/lib/actions/relatorios";
...
export default async function NovoRelatorioPage() {
  const [clientes, semanas] = await Promise.all([
    ...
    <div className="p-6 flex flex-col gap-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-text-muted">Gere um relatório semanal para compartilhar com o cliente</p>
        </div>
      </div>
